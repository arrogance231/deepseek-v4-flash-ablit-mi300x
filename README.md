...
| Context limit | `600,000` configured (not yet validated on this MI300X) |
...
configured 600K profile, not a claim of full 600K narrative validation. Validate memory, recall, latency, and stability before production.
